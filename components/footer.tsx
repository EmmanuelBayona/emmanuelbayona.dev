...
export const Footer = ({ className }: { className?: string }) => {
    ...
    return (
        <footer className={cn('border-t border-dark-accent px-6 md:px-10 py-5 flex flex-col gap-y-5 lg:flex-row items-center justify-center lg:justify-between', className)}>

            <div className="flex flex-col items-center gap-y-5 lg:gap-y-2">
                <a
