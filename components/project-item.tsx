...
export const ProjectItem = ({ title, publishedAt, summary, className }: ProjectItem) => {
    ...
    return (
        <article className={cn('md:hover:bg-pink-600 md:p-4 md:rounded-xl group',
            'md:hover:shadow-pink transition-all duration-200', className)}>

            <h2 className="text-white">
                {title}
            </h2>

            <p className="my-1 md:group-hover:text-white/80">
                {summary}
            </p>

            <div className="flex gap-2 items-center md:group-hover:text-white/80">
