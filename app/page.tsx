...
import { MouseFollowTooltip } from "components/mouse-follow-tooltip";
...
export default function Home() {
    return (
        <>
            ...
            <MaxWidthWrapper className="dashes mb-4">
                <MouseFollowTooltip
                    message="View source on GitHub"
                    className="-mt-2 mx-auto"
                >
                    <a href="https://github.com/EmmanuelBayona/emmanuelbayona.dev" target="_blank"
                        aria-label="View source on GitHub" rel="noopener noreferrer"
